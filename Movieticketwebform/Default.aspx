    ...
    <div class="row">
        <div class="col-md-4 col-sm-6">
            <div class="stat-card card-red">
                ...
                <a href="Movie.aspx" class="view-link">View Details →</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="stat-card card-blue">
                ...
                <a href="Theater.aspx" class="view-link">View Details →</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="stat-card card-green">
                <div class="stat-value"><asp:Label ID="lblShows" runat="server" Text="0" /></div>
                <div class="stat-label">Total Shows</div>
                <a href="Show.aspx" class="view-link">View Details →</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="stat-card card-orange">
                ...
                <a href="Ticket.aspx" class="view-link">View Details →</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="stat-card card-pink">
                <div class="stat-value"><asp:Label ID="lblUsers" runat="server" Text="0" /></div>
                <div class="stat-label">Total Users</div>
                <a href="User.aspx" class="view-link">View Details →</a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="stat-card card-brown">
                ...
                <a href="Hall.aspx" class="view-link">View Details →</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        new Chart(document.getElementById('theaterChart'), {
            ...
            data: {
                ...
                datasets: [{
                    data: theaterCounts,
                    backgroundColor: ['#1e90ff', '#e50914', '#00c853', '#ff6d00', '#aa00ff'],
                    borderWidth: 0
                }]
            },
            options: {
