            ...
            <div class="card-table">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Price Type Name">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("PRICETYPENAME") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="PRICETYPENAMETextBox" runat="server" Text='<%# Bind("PRICETYPENAME") %>' CssClass="form-control form-control-sm" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Discount Rate">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("DISCOUNTRATE") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="DISCOUNTRATETextBox" runat="server" Text='<%# Bind("DISCOUNTRATE") %>' CssClass="form-control form-control-sm" />
                            </EditItemTemplate>
                        </asp:TemplateField>
