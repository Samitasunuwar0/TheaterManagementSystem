<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Genre.aspx.cs" Inherits="Movieticketwebform.Genre" %>
...
<body>
    <div class="topbar">Genre Table</div>
    <form id="form1" runat="server">
        <div class="page-wrapper">
            <div class="card-table">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="GENREID" DataSourceID="SqlDataSource1" CssClass="table table-hover mb-0" GridLines="None">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Genre Name">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("GENRENAME") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="GENRENAMETextBox" runat="server" Text='<%# Bind("GENRENAME") %>' CssClass="form-control form-control-sm" />
                            </EditItemTemplate>
                        </asp:TemplateField>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;GENRE&quot; WHERE &quot;GENREID&quot; = :GENREID" InsertCommand="INSERT INTO &quot;GENRE&quot; (&quot;GENREID&quot;, &quot;GENRENAME&quot;) VALUES (:GENREID, :GENRENAME)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;GENREID&quot;, &quot;GENRENAME&quot; FROM &quot;GENRE&quot;" UpdateCommand="UPDATE &quot;GENRE&quot; SET &quot;GENRENAME&quot; = :GENRENAME WHERE &quot;GENREID&quot; = :GENREID">
                <DeleteParameters>
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="GENREID" DataSourceID="SqlDataSource1">
                <EditItemTemplate>
                    <div class="form-panel">
                        <div class="form-panel-header">Update Genre</div>
                        <div class="form-panel-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">Genre ID</label>
                                    <asp:Label ID="GENREIDLabel1" runat="server" Text='<%# Eval("GENREID") %>' CssClass="form-control" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Genre Name</label>
                                    <asp:TextBox ID="GENRENAMETextBox" runat="server" Text='<%# Bind("GENRENAME") %>' CssClass="form-control" />
                                </div>
                            </div>
                            <div class="mt-4">
                ...
                <InsertItemTemplate>
                    <div class="form-panel">
                        <div class="form-panel-header">Insert New Genre</div>
                        <div class="form-panel-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">Genre ID</label>
                                    <asp:TextBox ID="GENREIDTextBox" runat="server" Text='<%# Bind("GENREID") %>' CssClass="form-control" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Genre Name</label>
                                    <asp:TextBox ID="GENRENAMETextBox" runat="server" Text='<%# Bind("GENRENAME") %>' CssClass="form-control" />
                ...
                <ItemTemplate>
                    <asp:LinkButton ID="NewButton" runat="server" CausesValidation="False" CommandName="New" Text="+ New Genre" CssClass="btn btn-dark mt-3" />
                </ItemTemplate>
            </asp:FormView>
