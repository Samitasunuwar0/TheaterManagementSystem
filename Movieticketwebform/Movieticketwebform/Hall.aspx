                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Hall Name">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("HALLNAME") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="HALLNAMETextBox" runat="server" Text='<%# Bind("HALLNAME") %>' CssClass="form-control form-control-sm" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Capacity">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("HALLCAPACITY") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="HALLCAPACITYTextBox" runat="server" Text='<%# Bind("HALLCAPACITY") %>' CssClass="form-control form-control-sm" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Theater ID">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("THEATERID") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("THEATERID") %>' />
                                <asp:HiddenField ID="HiddenTheaterID" runat="server" Value='<%# Bind("THEATERID") %>' />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <div class="form-panel-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:DropDownList ID="ddlTheaterEdit" runat="server" DataSourceID="SqlDataSourceTheater" DataTextField="THEATERNAME" DataValueField="THEATERID" SelectedValue='<%# Bind("THEATERID") %>' CssClass="form-select" AppendDataBoundItems="true">
                    ...
                    <div class="form-panel">
                        ...
                        <div class="form-panel-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">Theater</label>
                                    <asp:DropDownList ID="ddlTheaterInsert" runat="server" DataSourceID="SqlDataSourceTheater" DataTextField="THEATERNAME" DataValueField="THEATERID" SelectedValue='<%# Bind("THEATERID") %>' CssClass="form-select" AppendDataBoundItems="true">
                                        <asp:ListItem Value="" Text="-- Select --" />
                                    </asp:DropDownList>
                                </div>
                            </div>
